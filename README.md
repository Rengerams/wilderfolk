...
| **Social** | Settlers chat in **3-line dialogue trees** (work, home, courtship, fear, festivals); election gossip + marriage `Yes!` scripted moments; dialogue-bubble death cleanup, ellipsis overflow, and group-events scan cleanup |
...
| Install fails | Delete `node_modules` in `app/`, then run `npm install` again |
...
Full list → [TECHNICAL.md](TECHNICAL.md#running--building).
