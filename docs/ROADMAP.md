...
*Last updated: **August 8, 2026** · playing **v0.5.3** · cooking **v0.5.4***
...
| ✨ **Features** | ✅ **Multi-select workers** (shipped — shift-click select, assign all at once) · up next: sound effects by surface, weather with real consequences → [docs/archive/2026-08-03-game-feel-plan.md](docs/archive/2026-08-03-game-feel-plan.md) |
...
*Details (now complete — Phases 0–4 all shipped) in [docs/archive/2026-08-03-game-feel-plan.md](docs/archive/2026-08-03-game-feel-plan.md).*
