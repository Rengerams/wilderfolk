...
| Install fails | Delete `node_modules` (root and `app/`), install again |
...
Sim day length and other engine details live in code and the changelog — not required reading to *play*.
