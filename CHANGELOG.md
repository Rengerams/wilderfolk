...
- **Settler personality traits** — every villager gets 1–2 traits (💪 Hardy, 🛡️ Brave, 🗣️ Gregarious, 🐇 Timid, 🌿 Greenthumb, 🍀 Lucky, 💗 Nurturing, 🔮 Insightful) that subtly shape how they live: energy burn, hunting range, courtship pace, winter cold, conception luck, research speed, and child maturation. Children inherit each parent trait by a 50% chance (DNA-style) — a child can take after mom, dad, both, or neither. Assignment is softly gender-weighted: community & wisdom traits (nurturing, insightful, gregarious) skew toward women; frontier traits (hardy, brave) toward men — everyone can still draw any trait. Traits show in the inspector with tooltips
