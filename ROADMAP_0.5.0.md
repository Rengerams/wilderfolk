...
| Audience | Read this |
|----------|-----------|
| Players / store page | [README.md](README.md) · [docs/MARKETING_v0.5.0.md](docs/MARKETING_v0.5.0.md) |
...
Further perf/UI polish lives in private trackers (`private/OPEN_PROBLEMS.md`, `private/BUGS_TRACKER.md`) — not duplicated here so this file does not fight ROADMAP.md.
